...
public class HoaDonRepository {
    ...
    public List<ChiTietSanPham> findChiTietSanPhamByMaHoaDon(String maHoaDon) {
        ...
        String sql = " select maCTSP,SanPham.ten, ChatLieu.ten, KichThuoc.ten,MauSac.ten, Hang.ten, soLuongCon, giaBan, ChiTietSanPham.id, HoaDonChiTiet.soLuong  from ChiTietSanPham\n"
