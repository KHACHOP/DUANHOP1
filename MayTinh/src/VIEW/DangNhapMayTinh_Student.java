...
public class DangNhapMayTinh_Student extends javax.swing.JFrame {

   
    private NhanVienService nhanVienService = new NhanVienService();

    public DangNhapMayTinh_Student() {
        setUndecorated(true);
        initComponents();
    ...
    private void login() {
        ...
        if (nhanVien != null) {
            if (nhanVien.isTrangThaiXoa() != true) {
                JOptionPane.showMessageDialog(this, "Bạn không có thẩm quyền.");
                return;
            }
...
//    @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        panelGradiente1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(255, 153, 51), new java.awt.Color(102, 255, 102), null, null));
        panelGradiente1.setColorPrimario(new java.awt.Color(204, 204, 0));
        panelGradiente1.setColorSecundario(new java.awt.Color(204, 255, 204));
        ...
        panelBorder1.setBounds(190, 40, 310, 380);
    ...
    private void btnQuenMatKhauMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnQuenMatKhauMouseClicked
        ...
        if (nhanVien == null) {
            JOptionPane.showMessageDialog(this, "Số điện thoại của bạn không có trong hệ thống.");
            return;
        }
        // set mật khẩu mới.
        String matKhauMoi = "1";
        ...
        if (kq > 0) {
            try {
                ...
                Logger.getLogger(DangNhapMayTinh_Student.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void sendMailDangNhap(String mk, String email) throws MessagingException {
        ...
        String port = "587";
        String username = "hopnkph46001@fpt.vn.edu";
        String password = "ADMIN123@123";

        // Thông tin người gửi và người nhận
        String fromEmail = "hopnk99@gmai.com";
        ...
        try {
            ...
            message.setSubject("Mật khẩu của nhân viên : ");
            ...
            System.out.println("Email của bạn đã được gửi.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangNhapMayTinh_Student.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DangNhapMayTinh_Student().setVisible(true);
            }
        });
    }
